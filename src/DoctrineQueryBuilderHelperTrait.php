...
trait DoctrineQueryBuilderHelperTrait {
    ...
    public function whereFieldEqual(
        ...
        $fieldName = self::getUniqueFieldName($field);
    ...
    public function whereFieldLike(
        ...
        if ( is_array( $field ) ) {
            ...
            foreach ($field as $f) {
                $fieldName = self::getUniqueFieldName($f);
    ...
    public function whereFieldBetween(
        ...
        if ( $gte !== null && $lte !== null ) {
            $fieldNameGte = self::getUniqueFieldName($field.'_gte');
            $fieldNameLte = self::getUniqueFieldName($field.'_lte');
    ...
    private static function getUniqueFieldName(string $field): string {
